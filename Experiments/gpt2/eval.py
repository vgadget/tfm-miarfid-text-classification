...
tokenizer = Tokenizer.from_pretrained(pre_trained_model)
...
class NewsClassifierModel(nn.Module):
    ...
    def forward(self, input_ids, attention_mask, freeze_bert=True):
        ...
        hidden_state = o.get('last_hidden_state') # (bach_size, seq_len, dim)
        pooled_output = hidden_state[:, 0] # (bach_size, dim)
